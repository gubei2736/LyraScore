...
fs.writeFileSync(path.join(resDir, 'run_icons.ps1'), psCode, 'utf8');
execSync(`powershell -ExecutionPolicy Bypass -File "${path.join(resDir, 'run_icons.ps1')}"`, { stdio: 'inherit' });
